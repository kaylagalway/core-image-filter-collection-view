...
- (void)createNavigationBar {
   UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:[[ImageFiltersViewController alloc] init]];
...
/*
 ...
 UICollectionViewController *collectionVC = [[ImageCollectionViewController alloc] initWithCollectionViewLayout:collectionLayout];
 */
